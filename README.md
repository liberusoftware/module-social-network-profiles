...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-profiles?sort=semver)](https://github.com/liberusoftware/module-social-network-profiles/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-profiles/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-profiles/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-profiles
```
...
<a href="https://github.com/liberusoftware/module-social-network-profiles/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-profiles" alt="Contributors to liberusoftware/module-social-network-profiles">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-profiles/graphs/contributors).
